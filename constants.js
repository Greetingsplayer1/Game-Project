...
const text = document.getElementById("bobby");
const otherText = document.getElementById("bobbytwo");
const mainScren = document.getElementById("bob");
...
const mapObjects = [
    ...
    {x: -6575, y: -6475, h: 10200, w: 250},
    {x: -6325, y: 3425, h: 300, w: 8150},
    {x: 1825, y: -1280, h: 5000, w: 250},
    {x: 1825, y: -4410, h: 2200, w: 250},
    {x: -6575, y: -8280, h: 830, w: 250},
    {x: -6325, y: -8280, h: 300, w: 8150},
    {x: 1825, y: -8280, h: 2600, w: 250},

    //Cliff
    {x: -6170, y: -6405, h: 1900, w: 3875},
